...
export const EditIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-pencil-fill svg-align">
      <path
...
export const BinIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-trash-fill svg-align">
    <path
...
export const CloseIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-x-circle-fill svg-align">
      <path
...
export const SaveIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-save2-fill svg-align">
      <path
...
export const ExpandIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
         className="bi bi-chevron-expand svg-bold-align" viewBox="0 0 16 16">
      <path
...
export const CollapseIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
         className="bi bi-chevron-contract svg-bold-align" viewBox="0 0 16 16">
      <path
